...
date: '2020-11-24'
tags: ['pyenv', 'rvm', 'virtualenv']
draft: false
summary: Linux'ta gelisticiler icin kullanisli araclar
---
...
`-mindepth N`: Exclude matches less than N levels deep.
`-maxdepth N`: Do not descend more than N levels.
`mindepth` ile aramaya hangi alt dizinden baslamasi
gerektigini soyluyoruz, `maxdepth` ile hangi alt dizine kadar
arayabilecegini soyluyoruz.
...
![add ve commit isleyisi](/static/images/git_workflow.jpg)
